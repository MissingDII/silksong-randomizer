...
//            base(logger, new DataPackageCache(new ArchipelagoItemLoader(_jsonLoader), new ArchipelagoLocationLoader(_jsonLoader), "silksong", "BepInEx", "plugins", "Silkipelago", "IdTables"), itemReceivedFunction)
//        {
//        }
